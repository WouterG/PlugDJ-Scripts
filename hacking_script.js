...
// @name         PlugDJ Hacks
// @version      1.0
// @description  Modify HACK_CONFIG to your own settings
// @author       Wouto1997
// @match        https://plug.dj/*
// @grant        none
// ==/UserScript==
...
// CONFIG: 
var HACK_CONFIG = {
    username: "Wouto1997",  //  Your own username (case sensitive)
    id: 3909532,
    gRole: 5,               //  Global role, 0 is no global role, 3 is brand ambassador, 5 is admin
    tastycat_avatar: true,  //  Apply tastycat avatar in /tastycat. Only works if you select a base avatar (works in the room)
    avatar: "steve01",      //  Currently selected avatar, see https://rcs.radiant.dj/avatars
    sub: 1,                 //  Whether you're subscribed, 0 is not subscribed, 1 is subscribed.
    silver: true,
    badge: 'warrior-o01',   //  Currently selected badge, see https://rcs.radiant.dj/badges
    minimum_role: 5         //  If your role is lower than this, it'll be put to this. Valids are 0=default, 1=res dj, 2=bouncer, 3=manager, 4=cohost, 5=host.
};
...
HACK_CONFIG.avatar = 'robot15';
//HACK_CONFIG.sub = 0;
HACK_CONFIG.badge = 'raveb-s03';
...
var override_data = /*{
      ...
      "guest": false,
      "id": 4684278,
      "joined": "2012-07-29 07:29:54.095000",
      "language": "en",
      "level": 15,
      "silver": true,
      "slug": "fungus",
